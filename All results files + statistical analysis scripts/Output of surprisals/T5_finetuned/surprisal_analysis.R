library(dplyr)
#on wh_island   Wilcox original material
wh_island_1 <- read.csv("on_wh_island/wh-island_surprisals1_24.csv")
wh_island_2 <- read.csv("on_wh_island/wh-island_surprisals2_24.csv")
...
#fine_tuned on wh-island, test=original Wilcox material
wh_island_1 <- read.csv("on_wh_island/wh-island_surprisals1_24_epoch2.csv")
wh_island_2 <- read.csv("on_wh_island/wh-island_surprisals2_24_epoch2.csv")
wh_island <- rbind(wh_island_1,wh_island_2)
wh_island$item <- as.factor(rep(rep(1:22,times=c(3,3,3,3,2,6,3,2,4,6,4,4,4,3,4,2,2,2,4,3,2,3)),8))
wh_island$licenser <- c(rep("yes",288),rep("no",288))
wh_island$island <- rep(c(rep("that",144),rep("whether",144)),2)
...
#fine_tuned on mix_construction, test=original Wilcox material
wh_island_1 <- read.csv("on_mix_construction/wh-island_surprisals1_24.csv")
wh_island_2 <- read.csv("on_mix_construction/wh-island_surprisals2_24.csv")
wh_island <- rbind(wh_island_1,wh_island_2)
wh_island$item <- as.factor(rep(rep(1:22,times=c(3,3,3,3,2,6,3,2,4,6,4,4,4,3,4,2,2,2,4,3,2,3)),8))
wh_island$licenser <- c(rep("yes",288),rep("no",288))
wh_island$island <- rep(c(rep("that",144),rep("whether",144)),2)
...
#fine_tuned on mix_construction, test=original Wilcox material  epoch2
wh_island_1 <- read.csv("on_mix_construction/wh-island_surprisals1_24_epoch2.csv")
wh_island_2 <- read.csv("on_mix_construction/wh-island_surprisals2_24_epoch2.csv")
wh_island <- rbind(wh_island_1,wh_island_2)
wh_island$item <- as.factor(rep(rep(1:22,times=c(3,3,3,3,2,6,3,2,4,6,4,4,4,3,4,2,2,2,4,3,2,3)),8))
wh_island$licenser <- c(rep("yes",288),rep("no",288))
wh_island$island <- rep(c(rep("that",144),rep("whether",144)),2)
...
adjunct_island_1 <- read.csv("on_adjunct_island/adj-islands_surprisals1_32.csv")
adjunct_island_2 <- read.csv("on_adjunct_island/adj-islands_surprisals2_32.csv")
adjunct_island_3 <- read.csv("on_adjunct_island/adj-islands_surprisals3_32.csv")
adjunct_island_4 <- read.csv("on_adjunct_island/adj-islands_surprisals4_32.csv")
...
#fine_tuned on adjunct island (adjunct island)
adjunct_island_1 <- read.csv("on_adjunct_island/adj-islands_surprisals1_32_epoch2.csv")
adjunct_island_2 <- read.csv("on_adjunct_island/adj-islands_surprisals2_32_epoch2.csv")
adjunct_island_3 <- read.csv("on_adjunct_island/adj-islands_surprisals3_32_epoch2.csv")
adjunct_island_4 <- read.csv("on_adjunct_island/adj-islands_surprisals4_32_epoch2.csv")
adjunct_island <- rbind(adjunct_island_1,adjunct_island_2,adjunct_island_3,adjunct_island_4)
adjunct_island$item <- as.factor(rep(rep(1:20,times=c(3,3,3,3,4,3,3,4,4,2,3,3,3,5,4,4,3,4,3,2)),16))
adjunct_island$licenser <- c(rep("yes",528),rep("no",528))
adjunct_island$island <- rep(c(rep("modifier",132),rep("adjunct_back",132),rep("intervening_adj",132),rep("nonintervening_adj",132)),2)
...
adjunct_island_1 <- read.csv("on_mix_construction/adj-islands_surprisals1_32.csv")
adjunct_island_2 <- read.csv("on_mix_construction/adj-islands_surprisals2_32.csv")
adjunct_island_3 <- read.csv("on_mix_construction/adj-islands_surprisals3_32.csv")
adjunct_island_4 <- read.csv("on_mix_construction/adj-islands_surprisals4_32.csv")
adjunct_island <- rbind(adjunct_island_1,adjunct_island_2,adjunct_island_3,adjunct_island_4)
adjunct_island$item <- as.factor(rep(rep(1:20,times=c(3,3,3,3,4,3,3,4,4,2,3,3,3,5,4,4,3,4,3,2)),16))
adjunct_island$licenser <- c(rep("yes",528),rep("no",528))
adjunct_island$island <- rep(c(rep("modifier",132),rep("adjunct_back",132),rep("intervening_adj",132),rep("nonintervening_adj",132)),2)
...
#fine_tuned on mix_construction (adjunct island)
adjunct_island_1 <- read.csv("on_mix_construction/adj-islands_surprisals1_32_epoch2.csv")
adjunct_island_2 <- read.csv("on_mix_construction/adj-islands_surprisals2_32_epoch2.csv")
adjunct_island_3 <- read.csv("on_mix_construction/adj-islands_surprisals3_32_epoch2.csv")
adjunct_island_4 <- read.csv("on_mix_construction/adj-islands_surprisals4_32_epoch2.csv")
adjunct_island <- rbind(adjunct_island_1,adjunct_island_2,adjunct_island_3,adjunct_island_4)
adjunct_island$item <- as.factor(rep(rep(1:20,times=c(3,3,3,3,4,3,3,4,4,2,3,3,3,5,4,4,3,4,3,2)),16))
adjunct_island$licenser <- c(rep("yes",528),rep("no",528))
adjunct_island$island <- rep(c(rep("modifier",132),rep("adjunct_back",132),rep("intervening_adj",132),rep("nonintervening_adj",132)),2)
...
complexNP_island_1 <- read.csv("on_complexNP_island/complexNP-island_surprisals1_16.csv")
complexNP_island_2 <- read.csv("on_complexNP_island/complexNP-island_surprisals2_16.csv")
complexNP_island_3 <- read.csv("on_complexNP_island/complexNP-island_surprisals3_16.csv")
complexNP_island_4 <- read.csv("on_complexNP_island/complexNP-island_surprisals4_16.csv")
complexNP_island_5 <- read.csv("on_complexNP_island/complexNP-island_surprisals5_16.csv")
complexNP_island_6 <- read.csv("on_complexNP_island/complexNP-island_surprisals6_16.csv")
complexNP_island_7 <- read.csv("on_complexNP_island/complexNP-island_surprisals7_16.csv")
complexNP_island_8 <- read.csv("on_complexNP_island/complexNP-island_surprisals8_16.csv")
...
colnames(RESULTS) <- c("gap_licenser","gap","island","mean_sum_surprisals")
print(RESULTS)
(RESULTS$mean_sum_surprisals[2]-RESULTS$mean_sum_surprisals[1])-(RESULTS$mean_sum_surprisals[4]-RESULTS$mean_sum_surprisals[3])   #no_island_obj
(RESULTS$mean_sum_surprisals[6]-RESULTS$mean_sum_surprisals[5])-(RESULTS$mean_sum_surprisals[8]-RESULTS$mean_sum_surprisals[7])   #obj_prep
(RESULTS$mean_sum_surprisals[10]-RESULTS$mean_sum_surprisals[9])-(RESULTS$mean_sum_surprisals[12]-RESULTS$mean_sum_surprisals[11])  #no_island_subj
(RESULTS$mean_sum_surprisals[14]-RESULTS$mean_sum_surprisals[13])-(RESULTS$mean_sum_surprisals[16]-RESULTS$mean_sum_surprisals[15]) #subj_prep
(RESULTS$mean_sum_surprisals[18]-RESULTS$mean_sum_surprisals[17])-(RESULTS$mean_sum_surprisals[20]-RESULTS$mean_sum_surprisals[19])  #sub_that_rc
(RESULTS$mean_sum_surprisals[22]-RESULTS$mean_sum_surprisals[21])-(RESULTS$mean_sum_surprisals[24]-RESULTS$mean_sum_surprisals[23])  #sub_wh_rc
(RESULTS$mean_sum_surprisals[26]-RESULTS$mean_sum_surprisals[25])-(RESULTS$mean_sum_surprisals[28]-RESULTS$mean_sum_surprisals[27])  #obj_that_rc
(RESULTS$mean_sum_surprisals[30]-RESULTS$mean_sum_surprisals[29])-(RESULTS$mean_sum_surprisals[32]-RESULTS$mean_sum_surprisals[31])  #obj_wh_rc
...
#fine-tuned on complexNP, test=original Wilcox material (complexNP)  epoch2
complexNP_island_1 <- read.csv("on_complexNP_island/complexNP-island_surprisals1_16_epoch2.csv")
complexNP_island_2 <- read.csv("on_complexNP_island/complexNP-island_surprisals2_16_epoch2.csv")
complexNP_island_3 <- read.csv("on_complexNP_island/complexNP-island_surprisals3_16_epoch2.csv")
complexNP_island_4 <- read.csv("on_complexNP_island/complexNP-island_surprisals4_16_epoch2.csv")
complexNP_island_5 <- read.csv("on_complexNP_island/complexNP-island_surprisals5_16_epoch2.csv")
complexNP_island_6 <- read.csv("on_complexNP_island/complexNP-island_surprisals6_16_epoch2.csv")
complexNP_island_7 <- read.csv("on_complexNP_island/complexNP-island_surprisals7_16_epoch2.csv")
complexNP_island_8 <- read.csv("on_complexNP_island/complexNP-island_surprisals8_16_epoch2.csv")
complexNP_island <- rbind(complexNP_island_1,complexNP_island_2,
                          complexNP_island_3,complexNP_island_4,
                          complexNP_island_5,complexNP_island_6,
                          complexNP_island_7,complexNP_island_8)
...
complexNP_island_1 <- read.csv("on_mix_construction/complexNP-island_surprisals1_16.csv")
complexNP_island_2 <- read.csv("on_mix_construction/complexNP-island_surprisals2_16.csv")
complexNP_island_3 <- read.csv("on_mix_construction/complexNP-island_surprisals3_16.csv")
complexNP_island_4 <- read.csv("on_mix_construction/complexNP-island_surprisals4_16.csv")
complexNP_island_5 <- read.csv("on_mix_construction/complexNP-island_surprisals5_16.csv")
complexNP_island_6 <- read.csv("on_mix_construction/complexNP-island_surprisals6_16.csv")
complexNP_island_7 <- read.csv("on_mix_construction/complexNP-island_surprisals7_16.csv")
complexNP_island_8 <- read.csv("on_mix_construction/complexNP-island_surprisals8_16.csv")
complexNP_island <- rbind(complexNP_island_1,complexNP_island_2,
                          complexNP_island_3,complexNP_island_4,
                          complexNP_island_5,complexNP_island_6,
                          complexNP_island_7,complexNP_island_8)
...
complexNP_island_1 <- read.csv("on_mix_construction/complexNP-island_surprisals1_16_epoch2.csv")
complexNP_island_2 <- read.csv("on_mix_construction/complexNP-island_surprisals2_16_epoch2.csv")
complexNP_island_3 <- read.csv("on_mix_construction/complexNP-island_surprisals3_16_epoch2.csv")
complexNP_island_4 <- read.csv("on_mix_construction/complexNP-island_surprisals4_16_epoch2.csv")
complexNP_island_5 <- read.csv("on_mix_construction/complexNP-island_surprisals5_16_epoch2.csv")
complexNP_island_6 <- read.csv("on_mix_construction/complexNP-island_surprisals6_16_epoch2.csv")
complexNP_island_7 <- read.csv("on_mix_construction/complexNP-island_surprisals7_16_epoch2.csv")
complexNP_island_8 <- read.csv("on_mix_construction/complexNP-island_surprisals8_16_epoch2.csv")
complexNP_island <- rbind(complexNP_island_1,complexNP_island_2,
                          complexNP_island_3,complexNP_island_4,
                          complexNP_island_5,complexNP_island_6,
                          complexNP_island_7,complexNP_island_8)
